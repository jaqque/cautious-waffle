...
# Any number between 7 and 9, we'll get a brown egg.
# Any number between 10 and 12, we'll get a blue egg.
...
if ((chosen_number == 1) and (chosen_number <= 6)):
  egg = 'white'
elif ((chosen_number == 7) and (chosen_number <= 9)):
  egg = 'brown'
elif ((chosen_number == 10) and (chosen_number <= 12)):
  egg = 'blue'
else:
  egg = 'Call the farmer!'
